...
```bash
npx shadcn@latest add https://std-ui.vercel.app/registry/hint.json
```
...
<br />
```tsx
<Hint content="This is a hint" isAnimating={false}>
  <button>Hover me</button>
</Hint>
```
...
<br />
```tsx
<Hint content="This is a hint" animationStiffness={100}>
  <button>Hover me</button>
</Hint>
```
...
```tsx
<Hint content="This is a hint" animationFrom="left">
  <button>Hover me</button>
</Hint>
```
...
<br />
```tsx
<Hint content="This is a hint" enabled={false}>
  <button>Hover me</button>
</Hint>
```
...
<br />
```tsx
<Hint content="This is a hint" delay={1000}>
  <button>Hover me</button>
</Hint>
```

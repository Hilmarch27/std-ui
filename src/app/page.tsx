    ...
    <div className="h-[100svh] w-full z-[10] bg-background isolate relative overflow-hidden">
      <div>
        <Particles
          ...
          refresh
        />
        <Spotlight className="-top-40 left-0 md:left-60 md:-top-20 max-xl:hidden" fill="white" />
        <div className="absolute max-sm:hidden right-0 top-[5%] lg:w-[300px] sm:w-[200px] xl:w-[500px]">
          <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 837.88 252.83" className="">
            <defs>
          ...
          <p className="text-center pl-2 pt-8 text-sm text-white/90">• Components</p>
        </div>
        <div className="absolute max-sm:hidden left-0 top-[20%] lg:w-[300px] xl:w-[500px] sm:w-[200px]">
          <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 837.88 252.83">
            <defs>
          ...
          <p className="text-center pl-2 pt-8 text-sm text-white/90">• Shadcn</p>
        </div>
        <div className="absolute left-0 max-sm:hidden bottom-[5%] lg:w-[300px] sm:w-[200px] xl:w-[500px]">
          ...
          <p className="text-center pl-2 pb-8 text-sm text-white/90">• Blocks</p>
          <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 837.88 252.83">
            <defs>
        ...
        <div className="absolute top-0 right-[-50px] -z-10 transform-gpu overflow-hidden blur-3xl " aria-hidden="true">
          <div
        ...
        >
          <div
            style={{
              clipPath: 'polygon(0 0, 70% 12%, 86% 62%, 50% 100%, 0 100%, 0% 25%)'
            }}
